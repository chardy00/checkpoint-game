...
// ─────────────────────────────────────────────────────────────
const DAY_EVENTS = {
  1: { start: { type:'bulletin', title:'SHIFT BRIEFING — DAY 1',
  ...
  2: { start: { type:'bulletin', title:'REGULATION UPDATE — DAY 2',
  ...
  3: { start: { type:'bulletin', title:'HEALTH ALERT — DAY 3',
  ...
  4: { start: { type:'bulletin', title:'REGULATION UPDATE — DAY 4',
  ...
  5: { start: { type:'bulletin', title:'CHIP VERIFICATION + INTERPOL ALERT — DAY 5',
  ...
  7: { start: { type:'bulletin', title:'EU DIPLOMATIC SUMMIT — DAY 7',
  ...
  8: { start: { type:'terror_warning', title:'⚠ THREAT LEVEL ELEVATED — DAY 8',
  ...
  9: { start: { type:'bulletin', title:'UKRAINIAN SCREENING PROTOCOL — DAY 9',
  ...
  10: { end: { type:'consequence', title:'INCIDENT REPORT', dynamic:'mirko_day10' }},
  11: { start: { type:'bulletin', title:'INTERPOL RED NOTICE — DAY 11',
    ...
    secondaryEvent: { type:'news', title:'OVERNIGHT DETENTION — DAY 11',
  ...
  12: { start: { type:'bulletin', title:'INTERPOL PROTOCOL UPDATE — DAY 12',
  ...
  13: { start: { type:'bulletin', title:'SYRIAN PROCESSING SUSPENDED — DAY 13',
  ...
  14: { start: { type:'bulletin', title:'PRESS CREDENTIAL NOTICE — DAY 14',
  ...
  15: { start: { type:'bulletin', title:'BAVARIAN HEALTH DECLARATION LIFTED — DAY 15',
  ...
  17: { start: { type:'bulletin', title:'UKRAINIAN BILATERAL AGREEMENT — DAY 17',
  ...
  19: { start: { type:'bulletin', title:'ROME FLIGHT DISRUPTIONS — DAY 19',
  ...
  21: { start: { type:'phantom_message', title:'ENCRYPTED TRANSMISSION — SOURCE UNKNOWN',
